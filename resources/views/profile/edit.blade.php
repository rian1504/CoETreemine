...
@section('content')
    ...
    <div class="w-full h-full mt-36 flex flex-row justify-between gap-4">
        ...
        <div class="flex flex-row justify-end items-end gap-4 w-full h-full">
            {{-- Profile Information --}}
            <div class="max-w-xl w-1/3 bg-white p-8 rounded-lg shadow-md flex flex-col gap-8">
                <div class="flex flex-col gap-2">
                ...
                <form method="post" action="{{ route('profile.update') }}" class="flex flex-col gap-4">
                    ...
                    <div class="">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $user->name) }}"
                            class="w-full p-2 border border-gray-300 rounded-md focus:ring-buyer-green focus:border-buyer-green">
            ...
            <div class="max-w-xl w-1/3 bg-white p-8 rounded-lg shadow-md flex flex-col gap-8">
                ...
                <div class="border-t-4 border-buyer-green"></div>
                <form class="" method="post" action="{{ route('password.update') }}" class="flex flex-col gap-4">
                    @csrf
                    @method('put')
                    ...
                    <div class="relative mb-4 ">
                        ...
                        <input type="password" id="update_password_current_password" name="current_password"
                            ...
                            class="w-full p-2 border border-gray-300 rounded-md focus:ring-buyer-green focus:border-buyer-green">
                        <i class="absolute top-12 right-3 transform -translate-y-2/4 text-gray-500 hover:text-buyer-green cursor-pointer fas fa-eye-slash"
                    ...
                    <div class="relative mb-4">
                        <label class="block text-gray-700 font-semibold" for="update_password_password_confirmation">Confirm
                            Password</label>
