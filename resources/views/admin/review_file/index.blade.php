                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td rowspan="2" class="px-4 py-4 whitespace-nowrap truncate">
                            ...
                            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" data-id={{ $data->id_cart_custom }} class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                                Reject
                            </button>
                        </td>
                    </tr>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form id="rejectForm" class="space-y-4" action="{{ route('review_file.reject', ':id_cart_custom') }}">
                        @csrf

                        <input type="hidden" name="cart_custom" id="cart_custom">
                        <div>
                            <label for="reason" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                                Reason</label>
    ...
    $(document).ready(function() {
        ...
        $('[data-modal-hide="authentication-modal"]').click(function() {
            ...
            $('#rejectForm').attr('action', '{{ route('
                review_file.reject ', ': id_cart_custom ') }}');
