...
<div>
    ...
    <div class=" min-h-96 bg-white rounded-sm px-10 py-6">
        <div class="pb-4 flex flex-row justify-between">
            <div class="">
                <label for="prototype" class="text-sm font-medium text-gray-900 dark:text-white">Choose</label>
            ...
            <a href="{{ route('prototype.index') }}" class=" mt-5 max-w-20 font-semibold text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add
            </a>
        </div>
    </div>
