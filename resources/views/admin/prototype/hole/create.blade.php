...
@section('title', 'CoE Treemine | Prototype Min Hole Size')
...
<div>
    <div class="my-4 flex flex-row gap-4">
        ...
        <p>></p>
        <a href="/admin/prototype/hole">Min Hole Size</a>
        <p>></p>
        <a href="/admin/prototype/hole/create" class="text-admin-900">Create</a>
    </div>
