...
@section('title', 'CoE Treemine | Prototype Via Process')
...
<div>
    <div class="my-4 flex flex-row gap-4">
        ...
        <p>></p>
        <a href="/admin/prototype/via_process">Via Process</a>
        <p>></p>
        <a href="/admin/prototype/via_process/create" class="text-admin-900">Create</a>
    </div>
