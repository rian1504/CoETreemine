...
@section('title', 'CoE Treemine | Prototype Solder Mask')
...
<div>
    <div class="my-4 flex flex-row gap-4">
        ...
        <p>></p>
        <a href="/admin/prototype/solder">Solder Mask</a>
        <p>></p>
        <a href="/admin/prototype/solder/create" class="text-admin-900">Create</a>
    </div>
