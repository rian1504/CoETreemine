...
@section('title', 'CoE Treemine | Prototype Inner Cooper')
...
<div>
    <div class="my-4 flex flex-row gap-4">
        ...
        <p>></p>
        <a href="/admin/prototype/inner_cooper">Inner Cooper</a>
        <p>></p>
        <a href="/admin/prototype/inner_cooper/create" class="text-admin-900">Create</a>
    </div>
