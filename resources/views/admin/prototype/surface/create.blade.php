...
@section('title', 'CoE Treemine | Prototype Surface Finish')
...
<div>
    <div class="my-4 flex flex-row gap-4">
        ...
        <p>></p>
        <a href="/admin/prototype/surface">Surface Finish</a>
        <p>></p>
        <a href="/admin/prototype/surface/create" class="text-admin-900">Create</a>
    </div>
