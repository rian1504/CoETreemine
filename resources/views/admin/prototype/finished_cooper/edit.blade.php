...
@section('title', 'CoE Treemine | Prototype Finished Cooper')
...
<div>
    <div class="my-4 flex flex-row gap-4">
        ...
        <p>></p>
        <a href="/admin/prototype/finished_cooper">Finished Cooper</a>
        <p>></p>
        <a href="/admin/prototype/finished_cooper/create" class="text-admin-900">Edit</a>
    </div>
