    ...
    <div class=" min-h-[450px] shadow-lg bg-white rounded-sm px-10 py-6">
        <div class="pb-4 justify-between">
            ...
            <div class="relative mt-1">
                ...
                <input type="text" id="table-search" class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-dgreen-500 focus:border-dgreen-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-dgreen-500 dark:focus:border-dgreen-500" placeholder="Search for items">
            </div>
        </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4  whitespace-nowrap truncate">
                            <img src="{{ asset('/storage/assets/images/payment/' . $data->payment_proof) }}" class="w-16 md:w-32 max-w-full max-h-full" alt="{{ $data->payment_proof }}">
                        </td>
                        ...
                        <td class="px-6 py-4 flex flex-row gap-2 items-center ">
                            ...
                            class=" inline-flex items-center button-red">
                            View Detail
                            </a> --}}
                            <!-- Modal toggle -->
...
<script>
    $(document).ready(function() {
        ...
        $('button[data-modal-toggle="static-modal"]').on('click', function() {
            ...
            $.ajax({
                url: '/admin/history/order/' + id_order,
                method: 'GET',
