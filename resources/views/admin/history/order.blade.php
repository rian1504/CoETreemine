            ...
            <div class="pb-4 justify-between">
                ...
                <div class="relative mt-1">
                    ...
                    <input type="text" id="table-search"
                        class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-dgreen-500 focus:border-dgreen-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-dgreen-500 dark:focus:border-dgreen-500"
                    ...
                    <tbody>
                        @forelse ($datas as $index => $data)
                            <tr
                                ...
                                <td
                                    class="px-6 py-4 font-semibold {{ $data->status == 'done' ? 'text-green-600' : 'text-red-600' }}">
                                    {{ $data->status }}
                                </td>
                                <td class="px-6 py-4 items-center text-nowrap truncate">
                                    <!-- Modal toggle -->
