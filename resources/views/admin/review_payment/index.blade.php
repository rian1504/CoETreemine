                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap truncate">
                            <form action="{{ route('review_payment.reject', $data->id_order) }}" method="POST" onsubmit="return confirm('Are you sure want to reject?')">
                                @csrf
                                <button type="submit" class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-yellow-800">Reject</button>
                            </form>
