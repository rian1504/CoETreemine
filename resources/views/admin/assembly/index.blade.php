...
<<<<<<< HEAD
    ...
    <form class=" flex flex-row gap-4   ">
        ...
        <select id="countries" class=" max-w-40 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
...
>>>>>>> 8663bc6c82fae8fa56028ec41c7e733814dbfea9
</div>
@endsection