...
<div>
    ...
    <div
        class="w-full max-w-4xl p-4 mt-5 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        <form class="space-y-6 py-4" action="#">
            ...
            <div class="py-20 grid grid-cols-2">
                <button type="submit"
                    class="w-20 font-semibold text-white bg-admin-900 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 py-1 px-4 col-end-7 col-span-2 ">Send</button>
                <div>
        </form>
    </div>
