...
<div>
    <div class="my-4 flex flex-row gap-4">
        ...
        <p>></p>
        <a href="{{ route('progress.index') }}" class="text-admin-green">Product on Progress</a>
    </div>
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4  whitespace-nowrap truncate">
                            ...
                            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" data-id={{ $data->id_order }} class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Submit
                            </button>
                        </td>
                    </tr>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form id="submitForm" class="space-y-4" action="{{ route('progress.done', ':id_order') }}">
                        ...
                        <div>
                            <label for="shipping_method" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Shipping Method</label>
                            <input name="shipping_method" id="shipping_method" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required></input>
                            <label for="no_resi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                No Resi</label>
                            <input name="no_resi" id="no_resi" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required></input>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('[data-modal-hide="authentication-modal"]').click(function() {
            ...
            $('#submitForm').attr('action', '{{ route('
                review_file.reject ', ': id_order ') }}');
