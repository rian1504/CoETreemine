...
<div class="flex flex-col py-8 gap-8 h-full">
    <div class="bg-white rounded-lg shadow-lg">
        <div class="px-8 py-8">
            <h1 class="text-center text-greens-900 text-2xl font-bold my-6">Industrial Arduino Compatible Microcontrollers, Shields, and Accessories</h1>
    ...
    <div class="p-8 bg-white rounded-lg shadow-lg border-t-2 border-greens-900 w-full h-full">
    ...
    <div class="bg-white rounded-lg shadow-lg border-t-2 border-greens-900 h-full">
