...
<div class="flex flex-col my-8 gap-8">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        @endif
                        <th scope="row" class="px-5 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white flex flex-col gap-2">
                            <h1>Assembly</h1>
                        ...
                        <td class="px-5 py-3">
                            <!-- Modal toggle -->
                            <button data-modal-target="static-assembly-modal" data-modal-toggle="static-assembly-modal" data-id={{ $data->custom_assembly->id_custom_assembly }} class="hover:text-blue-600 font-medium text-sm text-center dark:text-blue-600 dark:hover:text-blue-700 dark:focus:ring-blue-800" type="button">
                                View Detail
                            </button>
                        </td>
                        <td class="px-5 py-3 text-center flex gap-2">
                            ...
                            <form action="{{ route('cart.custom.delete', $data->id_cart_custom) }}" method="POST" onsubmit="return confirm('Are you sure want to delete?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="px-5 py-2 bg-red-500 text-center rounded-lg text-white text-sm hover:bg-red-800">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-5 py-3 text-center">
                            ...
                            Detail</a> --}}
                            <!-- Modal toggle -->
                            <button data-modal-target="static-prototype-modal" data-modal-toggle="static-prototype-modal" data-id="{{ $data->custom_prototype->id_custom_prototype }}" class="hover:text-blue-600 font-medium text-sm text-center dark:text-blue-600 dark:hover:text-blue-700 dark:focus:ring-blue-800" type="button">
                                View Detail
                            </button>
                        </td>
                        <td class="px-5 py-3 text-center">
                            ...
                            <button data-modal-target="authentication-prototype-modal" data-modal-toggle="authentication-prototype-modal" data-id={{ $data->custom_prototype->id_custom_prototype }} class="button-blue">
                                Upload File
                            </button>
                            <h1>Not Completed</h1>
                            @else
                            ...
                            <form action="{{ route('cart.custom.delete', $data->id_cart_custom) }}" method="POST" onsubmit="return confirm('Are you sure want to delete?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="px-3 py-1 w-10 bg-red-500 text-center rounded-lg text-white text-sm hover:bg-gray-500"><i class="fas fa-trash"></i></button>
                            </form>
                        </td>
                    </tr>
                    @endif
    ...
    <div id="static-assembly-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-5xl max-h-full">
            ...
            <div class="relative bg-white shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="static-assembly-modal">
    ...
    <div id="static-prototype-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-5xl max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="static-prototype-modal">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                        </svg>
                        <span class="sr-only">Close modal</span>
    ...
    <div id="authentication-assembly-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="authentication-assembly-modal">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                        </svg>
                        <span class="sr-only">Close modal</span>
                ...
                <div class="p-4 md:p-5">
                    <form id="uploadForm" class="space-y-4" action="{{ route('cart.assembly.addFile', ':id_custom_assembly') }}" enctype="multipart/form-data" method="POST">
                        @csrf

                        <input type="hidden" name="custom_assembly" id="custom_assembly">
                        <div>
                            <label for="file" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Your
                                File</label>
                            <div class="relative flex items-center">
                                <input type="file" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" id="fileInput" name="file">
    ...
    <div id="authentication-prototype-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="authentication-prototype-modal">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                        </svg>
                        <span class="sr-only">Close modal</span>
                ...
                <!-- Modal body -->
                <div class="p-4 md:p-5">
                    <form id="uploadFormPrototype" class="space-y-4" action="{{ route('cart.prototype.addFile', ':id_custom_prototype') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        ...
                        <div>
                            <label for="file" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Your
                                File</label>
                            <div class="relative flex items-center">
                                <input type="file" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" id="fileInputPrototype" name="file">
                                <input type="text" class="w-full h-14 p-4 border border-admin-green rounded-l-lg focus:outline-none" placeholder="No file chosen" id="fileTextPrototype" readonly>
                                <button class="h-14 w-52 bg-admin-green text-white rounded-r-lg">
                                    Choose File
                                </button>
                            </div>
...
<script>
    ...
    $('[data-modal-hide="authentication-assembly-modal"]').click(function() {
        ...
        $('#uploadForm').attr('action', '{{ route('
            cart.assembly.addFile ', ': id_custom_assembly ') }}');
        // Reset nilai input hidden ke kosong
        $('#custom_assembly').val('');
        $('#fileInput').val('');
        $('#fileText').val('');
...
<script>
    ...
    $('[data-modal-hide="authentication-prototype-modal"]').click(function() {
        ...
        $('#uploadFormPrototype').attr('action',
            '{{ route('
            cart.prototype.addFile ', ': id_custom_prototype ') }}');
        // Reset nilai input hidden ke kosong
