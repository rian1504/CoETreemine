                    ...
                    <div class="w-2/3">
                        <div class="flex flex-row gap-4">
                            ...
                            <div class="flex items-center">
                                <input type="radio" name="flexible" id="flexible-{{ $index }}" value="{{ old('flexible', $data->id_flexible) }}" {{ $index == 0 ? 'checked' : '' }} class="hidden peer">
                ...
                <div class="side flex flex-row w-full">
                    ...
                    <div class="w-2/3 ">
                        <div class="flex flex-row gap-4">
                            ...
                            <div class="flex items-center">
                                <input type="radio" name="side" id="flex-{{ $index }}" value="{{ old('side', $data->id_side) }}" {{ $index == 0 ? 'checked' : '' }} class="hidden peer">
