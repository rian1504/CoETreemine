    ...
    <div class="flex flex-row mb-8 -mt-4 gap-4">
        ...
        <div class="w-3/4">
            <div class="w-full py-4 flex justify-between gap-4">
                <button class="w-1/2 button-grey" type="reset" id="reset"><i
                                ...
                                @foreach ($datas['dataFlexible'] as $index => $data)
                                    <div class="flex items-center">
                                        ...
                                        <label for="flexible-{{ $index }}"
                                            class="label-radio">{{ $data->flexible_name }}</label>
                                    </div>
                                @endforeach
                            </div>
                                ...
                                @foreach ($datas['dataBoard'] as $index => $data)
                                    <div class="flex items-center">
                                        ...
                                        <label for="board-{{ $index }}"
                                            class="label-radio">{{ $data->board_type_name }}</label>
                                    </div>
                                @endforeach
                            </div>
                                ...
                                @foreach ($datas['dataSide'] as $index => $data)
                                    <div class="flex items-center">
                                        ...
                                        <label for="flex-{{ $index }}"
                                            class="label-radio">{{ $data->side_name }}</label>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="w-2/3 ">
                            ...
                            <div class="">
                                ...
                                <div class="sensitive_description hidden">
                                    <textarea name="sensitive_description" id="sensitive_description" rows="4" class="textarea-form"
                        ...
                        <div class="w-2/3 ">
                            <div class="">
                                <div class="detail_information">
                                    <textarea name="detail_information" id="detail_information" rows="4" class="textarea-form"
                                        placeholder="Write your thoughts here..."></textarea>
                                </div>
                            </div>
                        </div>
