            ...
            <form action="{{ route('buyer.assembly.store') }}" method="POST" class="w-full flex flex-col gap-4 text-sm">
                    ...
                    <div class="w-2/3">
                        <div class="flex flex-row gap-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="flexible-{{ $index }}" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">{{ $data->flexible_name }}</label>
                            </div>
                            @endforeach
                        </div>
                ...
                <div class=" board flex flex-row w-full">
                    ...
                    <div class="w-2/3 ">
                        ...
                        <p class="text-xs text-yellow-300 mt-2">We suggest choose to do panel if single PCB qty is more than 20pcs or any side of single board is smaller than 50mm.</p>
                    </div>
                </div>
                    ...
                    <div class="w-2/3 ">
                        <div class="flex flex-row gap-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="flex-{{ $index }}" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">{{ $data->side_name }}</label>
                            </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="quantity flex flex-row w-full">
                    ...
                    <input type="number" name="quantity" id="quantity" class="w-20 h-9 py-2 px-3 border border-custom-grey shadow-sm focus:outline-none focus:border-buyer-green dark:focus:border-white">
                        ...
                        <div class="">
                            <div class="sensitive inline-flex flex-row gap-4 my-2">
                                <div class="flex items-center">
                                    ...
                                    <label for="sensitive-no" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">No</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" name="sensitive" id="sensitive-yes" value="yes" class="hidden peer">
                                    <label for="sensitive-yes" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">Yes</label>
                                </div>
                            </div>
                            <div class="sensitive_description hidden">
                                <textarea name="sensitive_description" id="sensitive_description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-custom-grey border border-custom-grey shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <p class="text-xs text-yellow-300">They can be left blank if you're not sure about the number of Unique Parts, SMT Parts, BGA/QFP Parts or THT parts.</p>
                <div class="unique flex flex-row w-full">
                    <label for="" class="w-1/3">Number of Unique Parts</label>
                    <input type="number" name="unique" class="w-20 py-2 px-3 border border-custom-grey shadow-sm focus:outline-none focus:border-buyer-green dark:focus:border-white">
                </div>
                <div class="smt flex flex-row w-full">
                    <label for="" class="w-1/3">Number of SMD Parts</label>
                    <input type="number" name="smt" class="w-20 py-2 px-3 border border-custom-grey shadow-sm focus:outline-none focus:border-buyer-green dark:focus:border-white">
                </div>
                <div class="bga flex flex-row w-full">
                    <label for="" class="w-1/3">Number of BGA/QFP Parts</label>
                    <input type="number" name="bga" class="w-20 py-2 px-3 border border-custom-grey shadow-sm focus:outline-none focus:border-buyer-green dark:focus:border-white">
                </div>
                <div class="through_hole flex flex-row w-full">
                    <label for="" class="w-1/3">Through Hole</label>
                    <input type="number" name="through_hole" class="w-20 py-2 px-3 border border-custom-grey shadow-sm focus:outline-none focus:border-buyer-green dark:focus:border-white">
                </div>
                <div class="depanel flex flex-row w-full">
                    ...
                    <div class="w-2/3 inline-flex flex-row gap-4">
                        <div class="flex items-center">
                            ...
                            <label for="depanel-no" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">No</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="depanel" id="depanel-yes" value="yes" class="hidden peer">
                            <label for="depanel-yes" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">Yes</label>
                        </div>
                    </div>
                </div>
                <div class="function_test flex flex-row w-full">
                    ...
                    <div class="w-2/3 inline-flex flex-row gap-4">
                        <div class="flex items-center">
                            ...
                            <label for="function-no" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">No</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="function_test" id="function-yes" value="yes" class="hidden peer">
                            <label for="function-yes" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">Yes</label>
                        </div>
                    </div>
                </div>
                <div class="cable_wire flex flex-row w-full">
                    ...
                    <div class="w-2/3 inline-flex flex-row gap-4">
                        <div class="flex items-center">
                            ...
                            <label for="cable-no" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">No</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="cable_wire" id="cable-yes" value="yes" class="hidden peer">
                            <label for="cable-yes" class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">Yes</label>
                        </div>
                    </div>
                </div>
                <div class="flex flex-row w-full">
                    ...
                    <div class="w-2/3 ">
                        <div class="">
                            <div class="detail_information">
                                <textarea name="detail_information" id="detail_information" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-custom-grey border border-custom-grey focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex justify-end mt-4">
                    <button class="w-1/6 py-2 px-4 bg-buyer-green text-white rounded-lg hover:bg-opacity-80 focus:outline-none focus:bg-opacity-80" onclick="calculate()"><i class="fas fa-calculator me-2"></i>Calculate</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="w-1/4 py-4 px-8 mt-4 bg-white rounded-lg shadow-lg h-1/6">
        ...
        <div id="calculate-section">
            ...
            <div class="flex flex-row justify-center text-sm whitespace-nowrap truncate">
                <button class="w-32 py-2 px-4 bg-buyer-green text-white rounded-lg hover:bg-opacity-80 focus:outline-none focus:bg-opacity-80" onclick="calculate()"><i class="fas fa-calculator me-2"></i>Calculate</button>
            </div>
        </div>
        <!-- Add to Cart Section -->
        <div id="add-to-cart-section" class="hidden">
            ...
            <div class="result flex flex-row justify-center items-center text-sm whitespace-nowrap truncate">
                <button type="submit" class="w-32 py-2 px-4 bg-buyer-green text-white rounded-lg hover:bg-opacity-80 focus:outline-none focus:bg-opacity-80" onclick="calculate()"><i class="fas fa-shopping-cart me-2"></i>Add to Cart</button>
            </div>
        </div>
    </div>
