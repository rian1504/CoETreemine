                    ...
                    <div class="layer flex flex-row w-full items-center">
                        ...
                        <div class="w-2/3 flex flex-row gap-4">
                            @foreach ($datas['dataLayer'] as $index => $data)
                                <input type="radio" id="layer-{{ $index }}" name="layer"
                                    value="{{ old('layer', $data->id_layer) }}" class="hidden peer" checked
                                    {{ $index == 0 ? 'checked' : '' }}>
                        ...
                        <div class="w-2/3 flex flex-row gap-4">
                            @foreach ($datas['dataMaterial'] as $index => $data)
                                <input type="radio" name="material" value="{{ old('material', $data->id_material) }}"
                                    class="hidden peer" checked {{ $index == 0 ? 'checked' : '' }}>
                        ...
                        <div class="w-2/3 flex flex-row gap-4">
                            @foreach ($datas['dataThickness'] as $index => $data)
                                <input type="radio" name="thickness"
                                    value="{{ old('thickness', $data->id_thickness) }}" class="hidden peer"
                                    {{ $index == 0 ? 'checked' : '' }}>
                                <label for="" class="label-radio">
                                    {{ $data->thickness_name }}
                                </label>
                    ...
                    <div class="finished_cooper flex flex-row w-full items-center">
                        ...
                        @foreach ($datas['dataFinishedCooper'] as $index => $data)
                            <input type="radio" name="finished"
                                value="{{ old('finished', $data->id_finished_cooper) }}" class="hidden peer"
                                {{ $index == 0 ? 'checked' : '' }}>
                            <label for="" class="label-radio">
