            ...
            <div class="w-full py-8 px-8 bg-white rounded-lg shadow-lg">
                ...
                <form action="{{ route('buyer.prototype.store') }}" method="POST"
                    ...
                    <div class="x_out flex flex-row w-full">
                        ...
                        <div class="w-2/3 inline-flex flex-row gap-4">
                            <div class="flex items-center">
                                ...
                                <label for="x_out-not"
                                    class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">Not
                                    Accept</label>
                            </div>
                            <div class="flex items-center">
                                <input type="radio" name="x_out" id="x_out-accept" value="accept" class="hidden peer"
                                    checked>
                                <label for="x_out-accept"
                                    class="cursor-pointer py-2 px-4 border-2 border-custom-grey shadow-sm peer-checked:border-green-500 peer-checked:bg-green-100">Accept</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="w-2/3 ">
                            <div class="">
                                <div class="panel_description">
                                    <textarea name="panel_description" id="panel_description" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-custom-grey border border-custom-grey focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500"
                    ...
                    <div class="flex flex-row w-full">
                        ...
                        <div class="route">
                            <select id="route_process" name="route"
                                class=" py-2 px-4 border-2 border-custom-grey text-gray-900 text-sm shadow-sm focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
                                @foreach ($datas['dataRoute'] as $index => $data)
                                    <option value="{{ old('route', $data->id_route) }}"
                                        {{ $index == 0 ? 'selected' : '' }} class="hover:bg-green-500">
                    ...
                    <div class="material">
                        @foreach ($datas['dataMaterial'] as $index => $data)
                            ...
                            <img src="{{ asset('/storage/assets/images/material/' . $data->material_picture) }}"
                                alt="" width="50" height="50">{{ $data->material_name }}
                        @endforeach
                    </div>
