        ...
        <div class="flex justify-center">
            <div class="inline-grid grid-cols-5 gap-4">
                ...
                <a href="{{ route('buyer.portfolio.showCategory', $data->id_category) }}">
                    <div class="flex flex-col justify-center items-center w-56 h-60 bg-white border border-grays-700 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 my-8">
                        ...
                        <div class="mx-6 my-6 md:my-6">
                            <h1 class="text-sm font-bold text-gray-900 dark:text-white">{{ $data->category_name }}</h1>
                        </div>
                    </div>
                </a>
                @empty
