                ...
                <div class="inline-grid grid-cols-5 gap-4">
                    @forelse ($datas->portfolio as $data)
                        <a href="{{ route('buyer.portfolio.showPortfolio', $data->id_portfolio) }}">
                            <div
                                class="flex flex-col justify-center items-start w-56 h-60 bg-white border border-grays-700 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 my-8">
                                <div class="w-full h-full shadow-lg overflow-hidden bg-gray-100">
                                    <img src="{{ asset('/storage/assets/images/portfolio/' . $data->portfolio_picture) }}"
                                        alt="Product Picture" class="w-full h-full object-cover">
                                </div>
                ...
                <div class="inline-grid grid-cols-5 gap-4">
                    @forelse ($datasAnother as $data)
                        <a href="{{ route('buyer.portfolio.showCategory', $data->id_category) }}">
                            <div
                                class="flex flex-col justify-center items-center w-56 h-60 bg-white border border-grays-700 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 my-8">
                                <div class="w-full h-full shadow-lg overflow-hidden bg-gray-100">
