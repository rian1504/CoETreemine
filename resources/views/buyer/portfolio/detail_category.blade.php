        ...
        <div class="flex justify-center">
            <div class="inline-grid grid-cols-5 gap-4">
                ...
                <a href="{{ route('buyer.portfolio.showPortfolio', $data->id_portfolio) }}">
                    <div class="flex flex-col justify-center items-start w-56 h-60 bg-white border border-grays-700 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 my-8">
