<nav class="flex flex-col fixed top-0 z-50 w-full">
            ...
            <div class="flex w-1/2 justify-end items-center gap-4">
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        ...
                        <h1 class="font-bold">Rian Abdullah</h1>
                        <!-- Dropdown menu -->
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                            <div class="px-4 py-3">
                                <span class="block text-sm dark:text-white">Rian Abdullah</span>
                                <span class="block text-sm text-gray-500 truncate dark:text-gray-400">rian@gmail.com</span>
                            </div>
    ...
    <div class="bg-greens-900 h-16 w-full" id="navbar-user">
        <ul class="flex flex-col ml-40 text-lg text-white font-medium p-4 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
                <a href="/buyer_service" class="block py-2 px-3 hover:text-black md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</a>
            </li>
        </ul>
    </div>
</nav>