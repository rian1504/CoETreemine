<nav class="flex flex-col fixed top-0 z-50 w-screen">
    ...
    <div class="bg-greens-900 w-full px-5 text-" id="navbar-user">
        <ul
            class="flex flex-col ml-40 text- text-white font-medium p-4 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
