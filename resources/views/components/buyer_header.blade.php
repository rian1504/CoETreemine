<nav class="flex flex-col fixed top-0 z-50 w-full">
    ...
    <div class="bg-greens-900 h-16 w-full id=" navbar-user">
        <ul class="flex flex-col ml-40 text-lg text-white font-medium p-4 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
                <a href="/buyer_custom" class="block py-2 px-3 hover:text-black md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Custom</a>
            </li>
            <li>
                <a href="/buyer_product_category" class="block py-2 px-3 hover:text-black md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Product</a>
            </li>
            <li>
