    ...
    <div class="px-3 py-4 overflow-y-auto h-full">
        <a href="{{ route('dashboard') }}" class="flex flex-col justify-center items-center p-2 mb-4 text-gray-900 rounded-lg dark:text-whit group">
            ...
            <svg class="w-10 h-10 md:hidden" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 1.5A8.5 8.5 0 0118.5 10 8.5 8.5 0 0110 18.5 8.5 8.5 0 011.5 10 8.5 8.5 0 0110 1.5zM10 0a10 10 0 100 20 10 10 0 000-20zM9 5v6h6v1H8V5h1z"></path>
            </svg>
        </a>
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('category.index') }}" class="{{ request()->is('admin/category_portfolio*') ? 'active' : '' }} flex items-center p-2  rounded-lg dark:text-white hover:bg-admin-900 hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="{{ route('portfolio.index') }}" class="{{ request()->is('admin/portfolio*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-900 hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="{{ route('prototype.index') }}" class="{{ request()->is('admin/prototype*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-900 hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="{{ route('assembly.index') }}" class="{{ request()->is('admin/assembly*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-900 hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="{{ route('review_file.index') }}" class="{{ request()->is('admin/review_file*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-900 hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="{{ route('review_payment.index') }}" class="{{ request()->is('admin/review_payment*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-900 hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a type="button" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example" class="{{ request()->is('admin/history*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-900 hover:text-white dark:hover:bg-gray-700 group">
