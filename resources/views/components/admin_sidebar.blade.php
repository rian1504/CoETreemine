    ...
    <div class="px-3 py-4 overflow-y-auto h-full">
        <a href="{{ route('dashboard') }}" class="flex flex-col justify-center items-center p-2 mb-4 text-gray-900 rounded-lg dark:text-whit group">
            ...
            <svg class="w-10 h-10 md:hidden" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 1.5A8.5 8.5 0 0118.5 10 8.5 8.5 0 0110 18.5 8.5 8.5 0 011.5 10 8.5 8.5 0 0110 1.5zM10 0a10 10 0 100 20 10 10 0 000-20zM9 5v6h6v1H8V5h1z">
                </path>
            </svg>
        </a>
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-0 flex flex-col gap-1">
                    <li>
                        <a href="{{ route('history.cart_custom') }}" class="{{ request()->is('admin/history/cart_custom') ? 'bg-gray-700 text-white' : 'text-gray-500' }} flex items-center p-2 ml-8 text-gray-900 rounded-lg dark:text-white hover:bg-gray-700 hover:text-white dark:hover:bg-gray-700 group">
                            <i class="{{ request()->is('admin/history/cart_custom') ? 'text-white' : 'text-gray-500' }} fas fa-shopping-cart text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white""></i>
                            <span class=" flex-1 ms-3 whitespace-nowrap">Cart Custom</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('history.order') }}" class="{{ request()->is('admin/history/order') ? 'bg-gray-700 text-white' : 'text-gray-500' }} flex items-center p-2 ml-8 text-gray-900 rounded-lg dark:text-white hover:bg-gray-700 hover:text-white dark:hover:bg-gray-700 group">
                            <i class="{{ request()->is('admin/history/order') ? 'text-white' : 'text-gray-500' }} fas fa-receipt mx-1 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white""></i>
