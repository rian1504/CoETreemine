<aside id="default-sidebar"
    ...
    <div class="px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
        <a href="/admin/dashboard"
            class="flex flex-col justify-center items-center p-2 mb-4 whitespace-nowrap text-gray-900 rounded-lg dark:text-white hover:bg-admin-900 hover:text-white dark:hover:bg-gray-700 group">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/admin/review_file"
                    ...
                    <span
                        class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-green-800 bg-green-100 rounded-full dark:bg-green-900 dark:text-green-300">3</span>
                </a>
            </li>
            <li>
                <a href="/admin/review_payment"
