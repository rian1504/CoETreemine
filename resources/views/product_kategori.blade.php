...
<body>
    ...
    <div class="inline-grid grid-cols-3">
        <div
            class="w-56 h-60 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ml-16 mt-16 mb-7">
            <div class="flex px-4 pt-4 justify-center ">
        ...
        <div
            class="w-56 h-60 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ml-20 mt-16 mb-7">
            <div class="flex px-4 pt-4 justify-center ">
