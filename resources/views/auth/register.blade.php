            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-10 dark:bg-white">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-4">
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Username<span
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}"
                                class="w-full px-3 py-2 border rounded-lg bg-gray-50 focus:outline-none focus:ring focus:ring-green-500 focus:border-green-500"
                                placeholder="coetreemine@yahui.kom" required>
                        ...
                        <div>
                            <label for="telp"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Phone Number<span
                                    class="text-red-500">*</span></label>
                        ...
                        <div class="flex items-center justify-between">
                            <a href="{{ route('login') }}"
                                class="underline text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Already
                                registered?</a>
                        </div>
                        <div class="flex items-center justify-center">
                            <button type="submit"
                                class="mt-6 text-white bg-greens-900 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Submit</button>
                    </form>
                </div>
            </div>
        </div>
