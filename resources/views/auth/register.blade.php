...
<div class="flex justify-center items-center h-full w-full my-8">
    <div class="px-6 py-10 w-1/3 bg-white rounded-lg shadow-lg ">
        ...
        <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <div>
                    <div class="flex">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-buyer-green focus:border-buyer-green block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-buyer-green dark:focus:border-buyer-green" placeholder="coetreemine@example.com" required autofocus autocomplete="username">
                    </div>
            ...
            {{-- Phone --}}
            <div>
                <label for="telp" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone Number<span class="text-red-500">*</span></label>
                <div class="flex">
                    <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 border-e-0 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                        <i class="fas fa-phone"></i>
                    </span>
                    <input type="number" name="telp" id="telp" placeholder="08xxxxxxxxxx" value="{{ old('telp') }}" class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-buyer-green focus:border-buyer-green block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-buyer-green dark:focus:border-buyer-green" required>
                </div>
            </div>
            ...
            <div class="relative">
                ...
                <div class="flex">
                    ...
                    <input type="password" name="password" id="password" placeholder="••••••••" class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-buyer-green focus:border-buyer-green block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-buyer-green dark:focus:border-buyer-green" required autocomplete="new-password">
                    <i class="absolute top-10 right-3 text-gray-500 hover:text-buyer-green cursor-pointer fas fa-eye-slash" onclick="showPassword()"></i>
                </div>
            ...
            <div class="relative">
                ...
                <div class="flex">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="••••••••" class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-buyer-green focus:border-buyer-green block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-buyer-green dark:focus:border-buyer-green" required autocomplete="new-password">
                    <i class="absolute top-10 right-3 text-gray-500 hover:text-buyer-green cursor-pointer fas fa-eye-slash" onclick="showPasswordConfirmation()"></i>
                </div>
