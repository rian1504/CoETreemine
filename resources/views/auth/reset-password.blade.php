            ...
            <div class="flex items-center justify-center p-4 leading-normal px-8 pt-6 pb-8 mb-4 ">
                <form class=" mx-auto space-y-6" method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="flex items-center justify-center">
                        <button type="submit"
                            class="text-white bg-greens-900 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Reset
                            Password</button>
                    </div>
                </form>
            </div>
