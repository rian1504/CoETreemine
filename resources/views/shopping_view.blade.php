...
<body>
    ...
    <div class="mt-10 flex justify-center gap-24">
        ...
        <div>
            <div class="inline-grid grid-cols-6 ml-12 mt-8 my-5">
            ...
            <div class="bg-gray-100 ml-10  mr-10 shadow-md p-0">
          ...
          <div class="ml-10">
                    ...
                    <div>
                    <div class="bg-gray-200 mt-10 ml-10 mr-10 shadow-md ">
                            <div class="flex items-center">
                      
                                <input id="update-check" type="checkbox"
                                    class="h-4 w-4 text-blue-600  focus:ring-blue-500 border-gray-300 rounded">
                                <label for="update-check" class="ml-2 block text-sm text-gray-800 ">Check All</label>
                            </div>
