            ...
            <div class="md:flex items-center justify-center p-2 leading-normal px-4 pt-2 pb-8  ">
                <form class=" pt-6 md:p-2 mx-auto space-y-4  ">
                    ...
                    <div class="flex items-center justify-between">
                        <a href="#" class="text-white bg-buyer-green hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">RESEND
