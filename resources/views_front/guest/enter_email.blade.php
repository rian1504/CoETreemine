...
<a href="email">
    ...
    <div class="flex items-center justify-center h-screen ">
        <div
            class="max-w-xl w-full mx-auto p-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="md:flex items-center justify-center p-2 leading-normal px-8 pt-6 pb-8 mb-4 ">
                <form class=" pt-6 md:p-8 mx-auto space-y-6  ">
                    ...
                    <div class="flex items-center justify-center">
                        <button type="submit"
                            class="text-white bg-greens-900 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Submit</button>
                    </div>
            </div>
        </div>
    </div>
