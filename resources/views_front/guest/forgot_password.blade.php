            ...
            <div class="md:flex items-center justify-center p-2 leading-normal px-4 pt-2 pb-8  ">
                <form class=" pt-6 md:p-2 mx-auto space-y-4  ">
                    ...
                    <div class="flex items-center justify-end">
                        <button type="submit" class="text-white bg-buyer-green hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-00 dark:hover:bg-green-700 dark:focus:ring-green-800">EMAIL PASSWORD RESET LINK</button>
                    </div>
                </form>
            </div>
        </div>
