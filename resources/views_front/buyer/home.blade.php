...
<div class="flex flex-col my-8 gap-4">
    <div class="bg-white rounded-lg">
        <div class="mx-8 my-8">
            <h1 class="text-center text-buyer-green text-2xl font-bold">Industrial Arduino Compatible Microcontrollers, Shields, and Accessories</h1>
    ...
    <div class="bg-white rounded-lg border-t-2 border-buyer-green">
        ...
        <div class="mx-8 my-8">
            ...
            <div class="flex justify-evenly">
                <div class="flex flex-col items-center">
                    ...
                    <p>From Rp <span class="text-buyer-green">300.000</span></p>
                </div>
                <div class="flex flex-col items-center">
                    <img src="/image/portfolio/arduino.jpeg" alt="" class="w-52 object-cover m-2">
                    <h1 class="font-semibold">Arduino</h1>
            ...
            <div class="flex justify-end my-8">
                <a href="/portfolio" class="flex w-auto h-7 p-4 items-center rounded-lg text-white bg-buyer-green">Show More</a>
            </div>
        </div>
    </div>
    <div class="bg-white rounded-lg border-t-2 border-buyer-green">
