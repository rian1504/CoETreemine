<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
        <a href="/admin/dashboard" class="flex flex-col justify-center items-center p-2 mb-4 whitespace-nowrap text-gray-900 rounded-lg dark:text-white hover:bg-admin-green hover:text-white dark:hover:bg-gray-700 group">
            <h1 class="text-2xl font-bold">CoETreemine</h1>
        </a>
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/admin" class="{{ request()->is('admin') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-green hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/admin/category_portfolio" class="{{ request()->is('admin/category_portfolio*') ? 'active' : '' }} flex items-center p-2  rounded-lg dark:text-white hover:bg-admin-green hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/admin/portfolio" class="{{ request()->is('admin/portfolio*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-green hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/admin/prototype" class="{{ request()->is('admin/prototype*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-green hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/admin/assembly" class="{{ request()->is('admin/assembly*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-green hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/admin/review_file" class="{{ request()->is('admin/review_file*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-green hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/admin/review_payment" class="{{ request()->is('admin/review_payment*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-green hover:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/admin/history" class="{{ request()->is('admin/history*') ? 'active' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-admin-green hover:text-white dark:hover:bg-gray-700 group">
