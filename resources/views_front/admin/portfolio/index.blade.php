...
@section('content')
    ...
    <div>
        <div class="my-4 flex flex-row gap-4">
            ...
            <p>></p>
            <p class="text-admin-900">Portfolio</p>
        </div>
        ...
        <div class=" min-h-96 bg-white rounded-sm px-10 py-6">
            <div class="pb-4 flex flex-row justify-between">
                ...
                <a href="{{ route('portfolio.create') }}"
                    class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Add
                </a>
            </div>
                    ...
                    <tbody>
                        @forelse ($datas as $index => $data)
                            <tr
                                ...
                                <td class="px-4 py-4">
                                    <img class="h-auto max-w-32 rounded-lg shadow-xl dark:shadow-gray-800"
                                        src="{{ asset('/storage/assets/images/portfolio/' . $data->portfolio_picture) }}"
                                        alt="{{ $data->portfolio_picture }}">
                                </td>
                                <td class="px-4 py-4">
                                    {{ $data->category->category_name }}
                                </td>
                                <td class="px-4 py-4">
                                    <a href="{{ route('portfolio.edit', $data->id_portfolio) }}"
