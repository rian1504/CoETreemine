...
<div>
    <div class="my-4 flex flex-row gap-4">
        ...
        <p>></p>
        <a href="/portfolio/create" class="text-admin-900">Edit</a>
    </div>
    <div class=" min-h-96 bg-white rounded-sm px-10 py-6">
        <div class="flex flex-col mt-2 mb-6">
            <label for="" class="font-semibold mb-2">Portfolio</label>
        ...
        <div class="flex flex-col mt-2 mb-6">
            ...
            <select id="" class="rounded-lg text-gray-900 border-admin-900 p-4 bg-admin-100 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
                <option selected>Choose a portfolio category</option>
        ...
        <div class="flex flex-col mt-2 mb-6">
            ...
            <textarea type="text" class="rounded-lg text-gray-900 border-admin-900 px-4 pt-6 bg-admin-100 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Input a product descriptions"></textarea>
        </div>
        <div class="flex flex-col mt-2 mb-6">
            <label for="" class="font-semibold mb-2">Specification</label>
            <input type="text" class="rounded-lg text-gray-900 border-admin-900 p-4 bg-admin-100 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Input a product specification">
        </div>
        <div class="flex flex-col mt-2 mb-6">
