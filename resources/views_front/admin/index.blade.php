...
<div>
    <h1 class="my-4 text-admin-green">Dashboard</h1>
        ...
        <div class="grid grid-cols-3 gap-4 my-4">
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="/admin/category_portfolio" class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-admin-green rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        More Details
            ...
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="/admin/portfolio" class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-admin-green rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        More Details
                        <div class="rounded-full ms-2 w-5 bg-white">
                            <i class="fas fa-arrow-right text-admin-green"></i>
                        </div>
            ...
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="#" class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-admin-green rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        More Details
                        <div class="rounded-full ms-2 w-5 bg-white">
                            <i class="fas fa-arrow-right text-admin-green"></i>
                        </div>
            ...
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="/assembly" class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-admin-green rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        More Details
                        <div class="rounded-full ms-2 w-5 bg-white">
                            <i class="fas fa-arrow-right text-admin-green"></i>
                        </div>
            ...
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="/admin/history" class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-admin-green rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        More Details
                        <div class="rounded-full ms-2 w-5 bg-white">
                            <i class="fas fa-arrow-right text-admin-green"></i>
                        </div>
