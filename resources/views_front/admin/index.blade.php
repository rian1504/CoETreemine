        ...
        <div class="grid grid-cols-3 gap-4 my-4">
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="/admin/category_portfolio" class="button-green-admin">
                        More Details
            ...
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="/admin/portfolio" class="button-green-admin">
                        More Details
                        <div class="rounded-full ms-2 w-5 bg-white">
                            <i class="fas fa-arrow-right text-admin-green"></i>
                        </div>
            ...
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="#" class="button-green-admin">
                        More Details
                        <div class="rounded-full ms-2 w-5 bg-white">
                            <i class="fas fa-arrow-right text-admin-green"></i>
                        </div>
            ...
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="/assembly" class="button-green-admin">
                        More Details
                        <div class="rounded-full ms-2 w-5 bg-white">
                            <i class="fas fa-arrow-right text-admin-green"></i>
                        </div>
            ...
            <div class="max-w-sm bg-white border border-admin-green rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center justify-center p-5">
                    ...
                    <a href="/admin/history" class="button-green-admin">
                        More Details
                        <div class="rounded-full ms-2 w-5 bg-white">
                            <i class="fas fa-arrow-right text-admin-green"></i>
                        </div>
